<div class="header">
    <div class="header-left active">
        <a href="{{ url('/dashboard') }}" class="logo logo-normal" style="width: 60px; position: relative; left:80px">
    ...
    <div class="dropdown mobile-user-menu">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            ...
            <button class="dropdown-item logout pb-0" id="logout-mobile">Logout</button>
        </div>
    </div>
</div>
