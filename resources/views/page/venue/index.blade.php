...
<div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="nama_lokasi" class="form-label fs-14">Nama Lokasi</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="nama_lokasi" placeholder="">
                                </div>
                            </div>
                            <div class="mb-3">
...
<script>
    ...
    $(document).ready(function() {
        ...
        window.validateAndSubmit = function() {
            ...
            if (!nama_lokasi) {
                $('#nama_lokasi').text('Berat Badan harus diisi').show();
                isValid = false;
            }
            if (!latitude) {
                $('#latitude').text('Tinggi Badan harus diisi').show();
                isValid = false;
            }
            if (!longitude) {
                $('#longitude').text('Kontingen harus dipilih').show();
                isValid = false;
            }
            ...
            if (isValid) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            title: "Berhasil !",
                            text: "Data Venue Sudah Disimpan",
                            icon: "success",
